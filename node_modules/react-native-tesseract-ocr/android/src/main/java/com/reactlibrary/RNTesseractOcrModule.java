...
public class RNTesseractOcrModule extends ReactContextBaseJavaModule {
		...
		new Handler().postDelayed(new Runnable() {
			...
			public void run() {
				...
				if (!netInfo.equalsIgnoreCase("none")) {
					...
					try {
						serviceIntent = new Intent(reactContext,
								Class.forName("de.mpg.mpdl.labcam.MyTaskService"));
						Log.e("startService", netInfo);
						serviceIntent.putExtra("internetType", netInfo);
	...
	@ReactMethod
	public void query(final Promise promise) {
		SQLiteDatabase readableDatabase = null;
		readableDatabase = ReactDatabaseSupplier.getInstance(reactContext).getReadableDatabase();
		if (readableDatabase != null) {
			...
			try {
				...
				String photos =  com.reactlibrary.AsyncLocalStorageUtil.getItemImpl(readableDatabase,"photos");
				Log.e(TAG, photos);
				com.reactlibrary.AsyncLocalStorageUtil.setItemImpl(readableDatabase, "photos", "");
