...
public class NetService extends JobService {
    ...
    public String query(String key) {
        ...
        if (readableDatabase != null) {
            ...
            try {
                readableDatabase = ReactDatabaseSupplier.getInstance(this).getReadableDatabase();
                String result =  com.reactlibrary.AsyncLocalStorageUtil.getItemImpl(readableDatabase, key);
                return result;
    ...
    public void write(String key, String updateValue) {
        ...
        if (readableDatabase != null) {
            ...
            try {
                readableDatabase = ReactDatabaseSupplier.getInstance(this).getReadableDatabase();
                com.reactlibrary.AsyncLocalStorageUtil.setItemImpl(readableDatabase, key, updateValue);
